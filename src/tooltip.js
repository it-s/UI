angular.module('com.likalo.ui')
  .directive('uiTooltip', [
    ...
    '$timeout',
    '$uiTools',
    function ($window, $document, $timeout, $uiTools) {
      ...
      function position(popup, source, position) {
        var windowRect = {
          ...
          sourceRect = $uiTools.elementUnwrap(source).getBoundingClientRect(),
          popupRect = $uiTools.elementUnwrap(popup).getBoundingClientRect(),
          top, left, hint;
